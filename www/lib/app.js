...
exports.FetcherImpl = exports.APIUpdaterImpl = exports.APIUpdaterMock = undefined;

var _APIWrapperURL = require("./APIWrapperURL");

var _APIWrapperURL2 = _interopRequireDefault(_APIWrapperURL);
...
var APIUpdater = function APIUpdater(behaviourLs, transformer, fetcher) {
    _classCallCheck(this, APIUpdater);
...
var APIUpdaterMock = exports.APIUpdaterMock = function (_APIUpdater) {
    _inherits(APIUpdaterMock, _APIUpdater);

    function APIUpdaterMock(behaviourLs) {
        _classCallCheck(this, APIUpdaterMock);

        return _possibleConstructorReturn(this, (APIUpdaterMock.__proto__ || Object.getPrototypeOf(APIUpdaterMock)).call(this, behaviourLs, new NonTransformer(), new FetcherMock()));
    }

    return APIUpdaterMock;
}(APIUpdater);

var APIUpdaterImpl = exports.APIUpdaterImpl = function (_APIUpdater2) {
    _inherits(APIUpdaterImpl, _APIUpdater2);

    function APIUpdaterImpl(behaviourLs) {
        _classCallCheck(this, APIUpdaterImpl);

        return _possibleConstructorReturn(this, (APIUpdaterImpl.__proto__ || Object.getPrototypeOf(APIUpdaterImpl)).call(this, behaviourLs, new NonTransformer(), new FetcherImpl()));
    }

    return APIUpdaterImpl;
}(APIUpdater);

var Transformer = function Transformer() {
    _classCallCheck(this, Transformer);

    this.transform = function (originJson) {
        return _Devices.DeviceFactory.create(originJson);
    };
};

var NonTransformer = function (_Transformer) {
    _inherits(NonTransformer, _Transformer);

    function NonTransformer() {
        _classCallCheck(this, NonTransformer);

        var _this3 = _possibleConstructorReturn(this, (NonTransformer.__proto__ || Object.getPrototypeOf(NonTransformer)).call(this));

        _this3.transform = function (deviceList) {
            return deviceList;
        };
        return _this3;
    }

    return NonTransformer;
}(Transformer);

var Fetcher = function Fetcher() {
    _classCallCheck(this, Fetcher);

    this.start = function (originJsonBehaviour) {};
};

var FetcherImpl = exports.FetcherImpl = function (_Fetcher) {
    _inherits(FetcherImpl, _Fetcher);

    function FetcherImpl() {
        _classCallCheck(this, FetcherImpl);

        var _this4 = _possibleConstructorReturn(this, (FetcherImpl.__proto__ || Object.getPrototypeOf(FetcherImpl)).call(this));

        _this4.start = function (originJsonBehaviour) {
            Rx.Observable.interval(1000).subscribe(function (x) {
                ...
                Promise.all([fetchSocket(), fetchMP3Player()]).then(function (resultAll) {
                    ...
                    if (JSON.stringify(fetchResult) !== JSON.stringify(originJsonBehaviour.getValue())) originJsonBehaviour.onNext(fetchResult);
                });
            });
        };
        return _this4;
...
var FetcherMock = function (_Fetcher2) {
    _inherits(FetcherMock, _Fetcher2);

    function FetcherMock() {
        _classCallCheck(this, FetcherMock);
        ...
        var _this5 = _possibleConstructorReturn(this, (FetcherMock.__proto__ || Object.getPrototypeOf(FetcherMock)).call(this));

        var devices = [new _Devices.Socket({
            "deviceID": "socket1",
            "deviceKind": "socket",
            "isON": true
        }), new _Devices.MP3Player({
            "deviceID": "mp3Player1",
            "deviceKind": "mp3Player",
            "isPlay": true,
            "musicNumber": 1
        ...
        _this5.start = function (originJsonBehaviour) {
...
},{"./APIWrapperURL":5,"./Devices":6,"rx":2}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.APIWrapperImpl = undefined;

var _APIWrapperURL = require("./APIWrapperURL");

var _APIWrapperURL2 = _interopRequireDefault(_APIWrapperURL);

var _APIUpdater = require("./APIUpdater");
...
var APIWrapper = function APIWrapper() {
    ...
    this.updater = new _APIUpdater.APIUpdaterMock(this.deviceListBehaviour);
...
var APISetterMock = function (_APISetter2) {
    _inherits(APISetterMock, _APISetter2);
    ...
    function APISetterMock(list) {
        ...
        _this2.updateDevice = function (device) {
            ...
            var deviceIndex = ls.indexOf(originDevice);
...
},{"./APIUpdater":3,"./APIWrapperURL":5,"./Devices":6,"rx":2}],5:[function(require,module,exports){
"use strict";
...
var APIWrapperURL = function () {
    function APIWrapperURL() {
        _classCallCheck(this, APIWrapperURL);
    }

    _createClass(APIWrapperURL, null, [{
        key: "API_MOCK",
        get: function get() {
    ...
    return APIWrapperURL;
}();

exports.default = APIWrapperURL;
...
exports.MP3Player = exports.Socket = exports.DeviceFactory = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //import * as fetch from "node-fetch";
...
var DeviceFactory = exports.DeviceFactory = function () {
    function DeviceFactory() {
        _classCallCheck(this, DeviceFactory);
    }

    _createClass(DeviceFactory, null, [{
        key: "create",
        value: function create(originJson) {
            return originJson.map(function (json) {
                switch (deviceKind) {
        ...
        key: "push",
        value: function push(device) {
            var id = device.deviceID;
            var json = device.toJsonForPost();
            var method = "PUT";
            ...
            fetch(device.deviceAPIURL + "/" + device.dbid, { method: method, headers: headers, body: body });
        }
    }]);
...
var Device = function () {
    ...
    _createClass(Device, [{
        key: "deviceAPIURL",
        get: function get() {
            return _APIWrapperURL2.default.API_URL;
        }
    }], [{
        key: "deviceKind",
        get: function get() {
...
var Socket = exports.Socket = function (_Device) {
    _inherits(Socket, _Device);

    function Socket(json) {
        _classCallCheck(this, Socket);

        var _this = _possibleConstructorReturn(this, (Socket.__proto__ || Object.getPrototypeOf(Socket)).call(this, json));

        _this.isON = json.isON;
    ...
    _createClass(Socket, [{
        key: "deviceAPIURL",
        get: function get() {
            return _APIWrapperURL2.default.API_URL + "/socks";
        }
    }], [{
        key: "deviceKind",
        get: function get() {
...
var MP3Player = exports.MP3Player = function (_Device2) {
    _inherits(MP3Player, _Device2);

    function MP3Player(json) {
        _classCallCheck(this, MP3Player);

        var _this2 = _possibleConstructorReturn(this, (MP3Player.__proto__ || Object.getPrototypeOf(MP3Player)).call(this, json));

        _this2.isPlay = json.isPlay;
        _this2.musicNumber = json.musicNumber;
    ...
    _createClass(MP3Player, [{
        key: "deviceAPIURL",
        get: function get() {
            return _APIWrapperURL2.default.API_URL + "/mp3_players";
        }
    }], [{
        key: "deviceKind",
        get: function get() {
...
},{"./APIWrapperURL":5}],7:[function(require,module,exports){
"use strict";

var _p5_app = require("./p5_app.js");

var _APIWrapper = require("./APIWrapper/APIWrapper.js");
